            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  ...
                  <p><strong>${user.user_metadata?.full_name || 'Someone'}</strong> has invited you to join <strong>${organization.name}</strong> on Trello Clone.</p>
                  
                  ${organization.description ? `<p><strong>About:</strong> ${organization.description}</p>` : ''}
